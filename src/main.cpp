...
#if defined(NDEBUG)
# error "EMARKET cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5d8345489c89ac2b402c4ecc76aac1dee8f13a9974a4ed7d2dee40401eb11057");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // EMARKET: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "EMARKET Signed Message:\n";
...
{
    // EMARKET: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // EMARKET: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // EMARKET: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1501928414, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04329fd49c88893b30ab972aea11d42bdcbe5bc542e274dada2925807d8b04237c6f3698fe91dc1f8adf73ea45868d8a70c1668ae4f2f1ced23f140fa6d3a29f57") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1501928414;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1706263;
        ...
        assert(block.hashMerkleRoot == uint256("0x7a38da5cff14f10ccdf15939feaa30e3aa5d47053e544895853a11f5b3598321"));
...
unsigned char pchMessageStart[4] = { 0xca, 0xd7, 0x76, 0xd0 }; // EMARKET: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("EMARKETMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("EMARKETMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static EMARKETMiner(CWallet *pwallet)
{
    printf("EMARKETMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("emarket-miner");
    ...
    try { loop {
        ...
        printf("Running EMARKETMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("EMARKETMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&EMARKETMiner, pwallet));
}
